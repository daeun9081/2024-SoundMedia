...
function draw() {
  ...
  fill(41,37,47);
  triangle(708, 336, 785, 328, 753, 378); //785, 328
  fill(164,182,204);
  triangle(591, 208, 653, 227, 675, 163); //675. 163
  fill(174,198,227);
  triangle(591, 208, 675, 163, 582, 149);
  fill(43,78,126);
  triangle(785, 328, 755, 270, 696, 271); //755, 270
  fill(45,59,82);
  triangle(785, 328, 818, 265, 755, 270);
  fill(44,59,81);
  triangle(785, 328, 818, 265, 848, 320); //818, 265
  fill(105,140,179);
  triangle(818, 265, 826, 213, 756, 229 ); //756, 229
  fill(91,125,169);
